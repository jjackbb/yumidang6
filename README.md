...
| **1:1 채팅 (Chat)** | • 매칭된 동행 파트너와의 1:1 대화방<br>• 상대방 프로필 요약 (응답률, **당도 99.2**)<br>• 약속 정보 바로가기 및 실시간 메시지 전송 |
| **마이페이지 (MyPage)** | • 내 프로필 및 인증회원 뱃지<br>• **유미당 신뢰 지표: 당도 99.2 🍯 게이지** (기준 당도 50에서 49.2 상승)<br>• 참여 통계: 참여한 동행(14회), 동행 평점(4.9), 받은 후기(8개)<br>• 진행 예정 동행 요약 카드 및 취향 키워드/안전센터 메뉴 |
