    ...
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center bg-black/60 backdrop-blur-xs p-0 sm:p-4 animate-in fade-in duration-200">
      ...
      >
        ...
        <div className="p-5 space-y-4">
          ...
          {/* Date & Location */}
          <div className="p-3.5 bg-[#f8f9fc] rounded-2xl border border-gray-150 space-y-2 text-xs">
          ...
          <div className="space-y-1.5">
            ...
            {isHost || isClosed ? (
              <div className="p-3 bg-[#f5f3ff] border border-[#ded6fb] rounded-xl space-y-1">
          ...
          {post.partnerPreferences && (
            <div className="space-y-1.5">
              ...
              <div className="p-3 bg-gray-50 rounded-xl border border-gray-150 text-xs text-gray-700 leading-relaxed">
                {post.partnerPreferences}
              </div>
            </div>
          )}
          ...
          <div className="pt-2">
            {isHost ? (
              <div className="space-y-2">
                <div className="p-2.5 bg-purple-50 rounded-xl border border-purple-150 text-[11px] text-[#6c2cf5] font-semibold text-center">
                  💡 내가 등록한 1:1 동행 공고입니다.
                </div>
                <div className="grid grid-cols-2 gap-2">
                  ...
                  {!isClosed ? (
                    <button
                      ...
                      className="py-3 bg-amber-50 hover:bg-amber-100 text-amber-700 border border-amber-200 rounded-xl text-xs font-bold flex items-center justify-center gap-1.5 transition-colors"
                    >
